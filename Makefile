...
OFILES = gba.o font.o game.o $(patsubst %.c,%.o,$(wildcard images/*.c))
# images/garbage.o images/Title.o images/Map.o images/Battle-Grass.o images/Rules-Background.o images/Character-Select.o images/Arrow.o images/FemaleSprite.o images/FemaleSprite2.o images/FemaleSprite3.o images/Boss1.o images/Boss2.o images/Boss3.o images/Enemy1.o images/Enemy2.o images/Enemy3.o 
